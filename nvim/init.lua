...
vim.keymap.set("n", "<leader>sF", find_files_in_buffer_dir, { desc = "[S]earch Files in Buffer Dir" })
vim.keymap.set("n", "<leader>ss", builtin.builtin, { desc = "[S]earch [S]elect Telescope" })
vim.keymap.set("n", "<leader>sw", builtin.grep_string, { desc = "[S]earch current [W]ord" })
vim.keymap.set("n", "<leader>sg", builtin.live_grep, { desc = "[S]earch by [G]rep" })
vim.keymap.set("n", "<leader>sG", live_grep_in_buffer_dir, { desc = "[S]earch by [G]rep in Buffer Dir" })
...
--
-- 	if mode == "i" then
-- 		-- Insert mode: slightly blue tint
-- 		vim.api.nvim_set_hl(0, "Normal", { bg = "#1a1e2e" })
-- 	elseif mode == "v" or mode == "V" or mode == "" then
-- 		-- Visual mode: slightly purple tint
-- 		vim.api.nvim_set_hl(0, "Normal", { bg = "#1e1a2e" })
-- 	elseif mode == "R" then
-- 		-- Replace mode: slightly red tint
-- 		vim.api.nvim_set_hl(0, "Normal", { bg = "#2e1a1a" })
-- 	else
-- 		-- Normal mode: default tokyonight background
